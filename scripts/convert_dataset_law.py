...
task_definition = (
    ...
    "Does the clause define the applicable law as different from the law of the consumer’s country of residence?"
)
...
for _, row in df_train.iterrows():
    ...
    example = {
        ...
        "output": "Yes" if 'LAW' in label_type_list else "No"  # Check if 'CR' is in the list
    }
    if 'LAW' in label_type_list:
...
for _, row in df_test.iterrows():
    ...
    instance = {
        "input": row["text"],
        "output": ["Yes" if 'LAW' in label_type_list else "No"]
    }
