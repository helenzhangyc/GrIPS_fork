...
task_definition = (
    ...
    "Does this clause stipulate that duties to pay damages by the provider are limited or excluded?"
)
...
for _, row in df_train.iterrows():
    ...
    example = {
        ...
        "output": "Yes" if 'LTD' in label_type_list else "No"  # Check if 'CR' is in the list
    }
    if 'LTD' in label_type_list:
...
for _, row in df_test.iterrows():
    ...
    instance = {
        "input": row["text"],
        "output": ["Yes" if 'LTD' in label_type_list else "No"]
    }
