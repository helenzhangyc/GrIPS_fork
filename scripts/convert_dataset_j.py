...
task_definition = (
    ...
    "Does this clause state that any judicial proceeding is to be conducted in a place other than the consumer's residence (i.e. in a different city, different country)?"
)
...
for _, row in df_train.iterrows():
    ...
    example = {
        ...
        "output": "Yes" if 'J' in label_type_list else "No"  # Check if 'CR' is in the list
    }
    if 'J' in label_type_list:
...
for _, row in df_test.iterrows():
    ...
    instance = {
        "input": row["text"],
        "output": ["Yes" if 'J' in label_type_list else "No"]
    }
